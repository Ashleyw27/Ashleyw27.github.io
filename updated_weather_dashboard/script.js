$(document).ready(function () {
  ...
  //Getting the last city searched/clicked on from local storage and appending it's weather data to the page
  if (localStorage.getItem("lastCity")) {
    city = JSON.parse(localStorage.getItem("lastCity"));
  ...
  $("#search-btn").on("click", function (event) {
    ...
    //Saving the last city searched to local storage//
  ...
  function displayCityInfo() {
    ...
    //Saving the last city clicked on to local storage//
    localStorage.setItem("lastCity", JSON.stringify(city));
